...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className={`opacity-70 ${
      ...
      } mx-auto relative md:px-10 lg:px-5 pt-4 pb-2 w-full h-full items-center justify-between px-4 `} >
        <div className="hidden md:flex md:flex-nowrap items-center w-full">
           <div
          className={`flex content-center lg:justify-center justify-start w-[50px] ${isVisible? 'fill-mako-900 ease-in-out transition-colors duration-200' : 'fill-mako-800 ease-in-out transition-colors duration-200'}`}
          id="phoenix-logo"
        >
        ...
        <svg className="h-16" viewBox="0 0 512 512">
          ...
          <div className="space-x-4 items-center text-mako-500 w-full">
            <a
              href="/"
            ...
            <a
              ...
              className="sansation-bold bg-cyan-400 text-white text-2xl px-4 py-2 rounded-4xl"
            target="_blank">
              <p className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.6)] inline">Doctolib</p>
            </a>
          </div>
        </div>
