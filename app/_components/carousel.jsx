  ...
  return (
    <div className="relative w-full bg-transparent h-full">
      <div className="z-10 w-full h-full flex flex-col items-center justify-center mx-auto absolute">
        ...
        <h2 className="mt-3 pb-2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-3xl tracking-wide text-center text-mantis-50 sansation-regular">Traitement des Traumas, addictions, phobies</h2>
      </div>
